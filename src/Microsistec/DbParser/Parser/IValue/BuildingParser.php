...
class BuildingParser extends AbstractParser
{
    ...
    protected $possibilities = [
        'Casas residenciais' => ['type' => 1, "finality" => 1], // Tipo 2 Finalidade 1
        'Prédios residenciais' => ['type' => 1, 'finality' => 1],// Tipo 1 Finalidade 1
    ...
    public function parse($model, $domain = "", $account = "")
    {
        try {
            ...
            $building->neighborhood_id = $address['id_bairro'];
            $building->city_id = $address['id_cidade'];
            $building->state_id = $address['id_uf'];
